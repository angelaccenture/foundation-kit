...
This project is based on the https://github.com/aemsites/author-kit project and set up as a new project. You are expected to follow the coding style and practices established in the author-kit, but add functionality according to the needs of the site currently developed.
